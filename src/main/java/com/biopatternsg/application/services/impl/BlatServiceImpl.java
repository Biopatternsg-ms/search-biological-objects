...
public class BlatServiceImpl implements BuildBlatSearchOptionsService {
    ...
    @Override
    public List<BlatSearchOptionsResponse> execute(int reliability, String promoterRegion) {
        return blatRepository.fetchDataFromBlatSource(reliability, promoterRegion);
    }
}
